...
class Preprocess:
    ...
    def __preprocessing(self, df, is_train = True):
        cate_cols = ['assessmentItemID', 'testId', 'KnowledgeTag', 'grade']
...
class DKTDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        test, question, tag, correct, grade = row[0], row[1], row[2], row[3], row[4] # 추가한 feature에 따라 수정
        
        cate_cols = [test, question, tag, correct, grade]
