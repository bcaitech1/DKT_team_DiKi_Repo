...
def parse_args(mode='train'):
    ...
    parser.add_argument('--file_name', default='train_test_all_data.csv', type=str, help='train file name')
    parser.add_argument('--file_name_val', default='train_data.csv', type=str, help='train file name')
    
    parser.add_argument('--model_dir', default='models/', type=str, help='model directory')
    # parser.add_argument('--model_name', default='lstm.pt', type=str, help='model file name')
    parser.add_argument('--model_name', default='bert.pt', type=str, help='model file name')
    # parser.add_argument('--model_name', default='lstm_attn.pt', type=str, help='model file name')

    parser.add_argument('--name', default='bert_Time_Rasw_TTdata_hidden512_lossAdd_trainplus', type=str, help='model file name')
